...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220111_regagrooo_8f53fbb9c333c6a65994_20220111083907_archive.zip';
    const ARCHIVE_SIZE       = '24311937';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '8f53fbb-11083907';
    const SECONDARY_PACKAGE_HASH = 'e88a261-11083907';
    const VERSION            = '4.0.5.2';
    ...
    */
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.5.2==');
        $this->log('----------------------------------------------------');
